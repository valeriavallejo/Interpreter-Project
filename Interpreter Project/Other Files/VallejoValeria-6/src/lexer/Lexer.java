     ...
     public static void main(String args[]) {
        ...
        try {
            ...
            while (true) {
                ...
                System.out.println(tok.getSymbol() + "   " + p + ": "+lex.source.getLineno());
            }
        } catch (Exception e) {}
    }
 ...
 *  @param startPosition is the column in the source file where the token begins
 *  @param endPosition is the column in the source file where the token ends
 *  @param lineNumber is the row in the source file where the token in located
...
*/
    public Token nextToken() { // ch is always the next char to process
        if (atEOF) {
            if (source != null) {
                System.out.println(source.getProgramLines());
                source.close();
                source = null;
            }
            return null;
